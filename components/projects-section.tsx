...
const projects = [
  {
    ...
    url: "https://www.figma.com/design/g68aC4U8KudqJYQQJZhAdO/Dashboard?node-id=0-1&t=1By6QXNNkcyxqbOt-1",
  },
  {
    ...
    url: "https://www.figma.com/design/FvLUUeamGDJUBehQHiOnoE/physy-guru?node-id=0-2237&t=TvKo5LBt4JwZLflU-1",
  },
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            console.log(
              "[v0] Projects section is intersecting, triggering animations"
            );
    ...
    <section
      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8 relative z-10'>
        <div className='max-w-6xl mx-auto'>
          <h2
            ref={titleRef}
            className='text-3xl sm:text-4xl font-bold text-center mb-12 opacity-0'>
